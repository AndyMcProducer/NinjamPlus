...
{
    processAudioFrame (static_cast<const double*> (inputAudioFrame));
}

//==================================================================================
void Chromagram::processAudioFrame (const double* inputAudioFrame)
{
...
//==================================================================================
void Chromagram::processAudioFrame (const std::vector<double>& inputAudioFrame)
{
    processAudioFrame (inputAudioFrame.data());
}
...
void Chromagram::setInputAudioFrameSize (int frameSize)
{
    ...
    filteredFrame.resize (inputAudioFrameSize);
...
//==================================================================================
void Chromagram::downSampleFrame (const std::vector<double>& inputAudioFrame)
{
    downSampleFrame (inputAudioFrame.data());
}

//==================================================================================
void Chromagram::downSampleFrame (const double* inputAudioFrame)
{

...
public:
    ...
    void processAudioFrame (const double* inputAudioFrame);
     ...
     * @see setInputAudioFrameSize
     */
    void processAudioFrame (const std::vector<double>& inputAudioFrame);
...
private:
	...
	void downSampleFrame (const double* inputAudioFrame);
	void downSampleFrame (const std::vector<double>& inputAudioFrame);
    ...
    std::vector<double> filteredFrame;
